                           		...
                           		<table class="table table-striped table-bordered table-hover" id="table-materi">
                           			...
                           			<tbody>
                           				<?php
			                                ...
			                                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
								                ...
								                if($error != ""){
								                    if ($error == "Data berhasil diinput") {
                                                        ...
                                                        $tipe = "alert-danger";
                                                        $str = "Gagal!";
                                                        $msg = " Anda sudah mengunggah assessment ini sebelumnya";
                                                    } else{
								                        $tipe = "alert-danger";
								                        $str = "Gagal!";
			                                ...
			                                $sql = "select tanggal, link_soal, id_dosen, id_soal from Soal where substr(id_soal, 1, 2) = 'as' and id_dosen = (select id_dosen_wali from Mahasiswa where id_mhs = '" . $_SESSION['id_mhs'] . "') and tanggal = '" . date('y-m-d') . "';";
				                        ...
				                        <td>
				                            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">				                            	
				                                ...
				                                <input type="hidden" name="id_assignment" value="<?php echo 'as' .$_SESSION['id_mhs'] . $result['tanggal']; ?>">
