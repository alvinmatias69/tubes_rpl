    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div class="row">
                <!-- page header-->
                <div class="col-lg-12">
                    <h1 class="page-header">Koreksi Assessment</h1>
                </div>
                 <!-- end page header-->
                 <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Masukkan nilai baru untuk masing-masing assessment
                        </div>
                        		...
                        		<table class="table table-striped table-bordered table-hover" id="table-materi">
                        			...
                        			<tbody>
                        				<?php
									        ...
									        $sql = "select id_assignment, tanggal, id_mhs, link_jawaban, nilai from Assignment where substring(id_assignment,1,2) = 'as' and id_dosen ='" . $_SESSION['id_dosen'] . "';";
									        $stmt = $conn->prepare($sql);
									        $stmt->execute();
									        $result = $stmt->fetch(PDO::FETCH_ASSOC);
									        if (! $result) {
